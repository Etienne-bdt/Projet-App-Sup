...
class DeConvolutional_Block(nn.Module):
    ...
    def forward(self,x):
        ...
        deconv_1 = self.deconv1(x)
        batch_norm_1 = self.batch_norm1(deconv_1)
        relu_1 = self.relu1(batch_norm_1)
        
        conv_1 = self.conv1(relu_1)
        batch_norm_2 = self.batch_norm2(conv_1)
        relu_2 = self.relu2(batch_norm_2)
        
        conv_2 = self.conv2(relu_2)
        batch_norm_3 = self.batch_norm3(conv_2)

        output = self.relu3(batch_norm_3)

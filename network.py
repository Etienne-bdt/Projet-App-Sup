...
class Modele(nn.Module):
    ...
    # DECODEUR
        ...
        self.convolutional_block_decodeur1 = Convolutional_Block(out_channels*8 , out_channels *4)
        
        self.upsampling2 = nn.UpsamplingNearest2d(scale_factor=2) # si pas bon result changer le upsampling
        self.convolutional_block_decodeur2 = Convolutional_Block(out_channels *4 , out_channels *2)
        
        self.upsampling3 = nn.UpsamplingNearest2d(scale_factor=2) # si pas bon result changer le upsampling
        self.convolutional_block_decodeur3 = Convolutional_Block(out_channels *2 , out_channels)
        
        self.upsampling4 = nn.UpsamplingNearest2d(scale_factor=2) # si pas bon result changer le upsampling
        self.convolutional_block_decodeur4 = Convolutional_Block(out_channels , in_channels)
    ...
    def forward(self, image1, image2):
        ...
        upsampling2 =self.upsampling2(conv_block_1_dec)
        conv_block_2_dec=self.convolutional_block_decodeur2(upsampling2)
        
        upsampling3 =self.upsampling3(conv_block_2_dec)
        conv_block_3_dec=self.convolutional_block_decodeur3(upsampling3)
        
        upsampling4 =self.upsampling4(conv_block_3_dec)
        conv_block_4_dec=self.convolutional_block_decodeur4(upsampling4)
        
        output_final = self.sigmoid(conv_block_4_dec)
